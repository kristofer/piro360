...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './piro.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PIRO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PIRO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PIRO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PIRO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PIRO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PIRO actions', async () => {
      const arg = 42666;
